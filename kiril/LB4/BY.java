...
class BY extends DataBaseCar {
	...
	private int stepSave;
	private String FIO;
	private int probeg;

    BY(String nameCar, int god, int sell, String complex, String strana, 
			int dataSell, String nameMen, int stepSave, String FIO, int probeg) {
